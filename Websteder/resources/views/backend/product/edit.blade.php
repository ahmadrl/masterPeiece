...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          <label for="demo" class="col-form-label">Demo <span class="text-danger">*</span></label>
          <input id="demo" type="text" name="demo" placeholder="Enter website demo"  value="{{old('demo')}}" class="form-control">
          @error('demo')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        {{-- <div class="form-group">
          ...
          <input name="demo" class="form-control selectpicker"  multiple data-live-search="true"> --}}
              {{-- @foreach($items as $item)              
                @php 
                $data=explode(',',$item->demo);
                // dd($data);
                @endphp
