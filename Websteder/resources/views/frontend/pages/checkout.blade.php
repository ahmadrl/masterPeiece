                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country">
                                                <option value="SZ">Jordan</option>                                   
                                                <option value="SE">Syria</option>
                                                <option value="CH">Iraq</option>                                   
                                                <option value="YE">Palstine</option>
                                                <option value="ZM">Kuwait</option>
                                                <option value="ZW">Lebanon</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
