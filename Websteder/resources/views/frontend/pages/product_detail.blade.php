...
@endsection
@section('title','WEBSTEDER || PRODUCT DETAIL')
											...
											<div class="product-buy">
												<form action="{{route('single-add-to-cart')}}" method="POST">
													...
													<div class="add-to-cart mt-4">
														...
														<a class="btn" title="Add to cart" href="{{route('add-to-cart',$product_detail->slug)}}">Add to cart</a>

															  <a class="btn" href={{$product_detail->demo}}>Show demo</a>
