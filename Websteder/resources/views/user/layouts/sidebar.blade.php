<ul style="background-color: rgb(73, 66, 59)" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">
<br>
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('user')}}">
     <img style="width: 150px" src="{{asset('backend/img/logo2.png')}}" alt="logo">
